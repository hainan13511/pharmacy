...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/returnManufacturer.css" />
	</head>
	<body>
	<div>
		<!-- 编辑退还数量 -->
			...
			<div class="modal-dialog" style="width: 300px;">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><i class="icon icon-edit"></i>退还厂家</h4>
					</div>
				...
				<div class="panel-body">
				 ...
				 <div class="container-fluid div_seek">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6">
                            <input type="text" class="form-control ng-pristine ng-valid ng-touched" id="text-supply"  placeholder="请输入供应商名">
                            <label for="mcmStartTime" class="input-control-label-left text-right">供应商:</label>
                            <label for="inputAccountExample1" class="input-control-icon-left"><i class="icon icon-file-text"></i></label>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6">
                            <input type="text" class="form-control ng-pristine ng-valid ng-touched" id="text-uaccount"  placeholder="请输入经办人">
                            <label for="mcmStartTime" class="input-control-label-left text-right">经办人:</label>
                            <label for="inputAccountExample1" class="input-control-icon-left"><i class="icon icon-file-text"></i></label>
                        </div>
					...
					<div class="panel-search">
						...
						<input id="text-supply" type="text" class="form-control" placeholder="供应商">
						<input id="text-uaccount" type="text" class="form-control" placeholder="经办人">
					</div>
					<div id="">
		...
		<script src="../js/returnManufacturer.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>