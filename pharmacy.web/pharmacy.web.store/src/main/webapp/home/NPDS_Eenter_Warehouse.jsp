...
<script type="text/javascript">
	...
	function table(){
		$.ajax({
			url : "../NpdsEnterWarehouseTable.action",
			type : "post",
			...
			success : function(data) {
				...
				for (var i = 0; i < data.length; i++) {
					...
					td4.innerText = data[i].supplier

					var td5 = document.createElement('td');
					td5.innerText = data[i].number

					var td6 = document.createElement('td');
					td6.innerText = data[i].number*data[i].money
	...
	function count(){
		 $.ajax({
			url : "../NpdsEnterWarehouseTableCount.action",
			type : "post",
