			...
			<div class="panel-body ">
				<div class="container-fluid div_seek">
					...
					<div class="col-lg-1 col-md-2 col-sm-6"><button class="btn btn-warning" type="button" data-toggle="tooltip" id="refer" title="刷新"><i
						...
						<div class="col-lg-1 col-md-2 col-sm-6"><button  onclick="search()" class="btn btn-info" type="button" data-toggle="tooltip" title="搜索"><i
	...
	$(".form-date").datetimepicker(
{
	...
	function init(){
		//发送请求
		$.ajax({
					url : "../showDrugPrice.action", //跳转的页面
					...
					success : function(data) {
						...
						for (var i = 0; i < data.length; i++) {
							...
							var $td3 = $("<td>" + data[i].beforePrice + "</td>");
							var $td4 = $("<td>" + data[i].laterPrice + "</td>");
							var $td5 = $("<td>" + new Date(data[i].purchasingTime).Format('yyyy-MM-dd hh:mm:ss') + "</td>");
							var $td6 = $("<td>" + data[i].uname + "</td>");
	...
	function page(){
		$.ajax({
			url : "../DrugPriceCount.action",//跳转的页面
	...
	function search(){
		...
		console.log("时间开始："+begin+",结束："+end+",drug:"+drug+",operator="+operator);
