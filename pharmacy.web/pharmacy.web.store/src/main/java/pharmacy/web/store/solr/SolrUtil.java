package pharmacy.web.store.solr;
...
public class SolrUtil {
     ...
     * @throws Exception
     */
    public static void addDocumentByBean(DrugInfSolr drugInf, String core) throws Exception {
     ...
     * @throws Exception
     */
    public static void addDocumentByBeans(List<DrugInfSolr> persons, String core) throws Exception {
        HttpSolrClient.Builder builder = getSolrClient("/" + core);
        SolrClient solrClient = builder.build();
     ...
     * @throws Exception
     */
    public static List<DrugInfDto> getDocument(String core, DrugInfSolr drugInf, boolean isHighlighting, Integer start,
...
//        solrQuery.setRows(rows);
        ...
        List<DrugInfDto> persons = queryResponse.getBeans(DrugInfDto.class);
        // 直接获取的反回结果
//        SolrDocumentList docs = queryResponse.getResults();
     ...
     * @throws IOException
     */
    public static void addDate(String core, DrugInfSolr drugInf) throws SolrServerException, IOException {
        // 创建连接对象
        HttpSolrClient.Builder builder = getSolrClient("/" + core);
        SolrClient solrClient = builder.build();
     ...
     * @throws IOException
     */
    public static void updateDate(String core, DrugInfDto drugInf) throws SolrServerException, IOException {
        // 创建连接对象
        HttpSolrClient.Builder builder = getSolrClient("/" + core);
        SolrClient solrClient = builder.build();
     ...
     * @throws Exception
     */
    public static void deleteDocment(String core, DrugInfSolr drugInf) throws Exception {
