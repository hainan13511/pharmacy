;!function (win) {
	...
	Xadmin.prototype.init = function() {
		var tab_list_management = this.get_data();
		for(var i in tab_list_management){
			this.add_lay_tab(tab_list_management[i].title,tab_list_management[i].url,i);
		}
  ...
  Xadmin.prototype.father_reload = function() {
    ...
    if(typeof is_remember!="undefined")
          return false;
		return layui.data('tab_list_management')
	}
	/**
	 * [set_data 增加某一项]
	...
	Xadmin.prototype.set_data = function(title,url,id) {
		...
		layui.data('tab_list_management', {
		  key: id
  ...
  Xadmin.prototype.set_cate_data = function(data) {
	...
	Xadmin.prototype.del_data = function(id) {
		...
		if(typeof id!="undefined"){
			...
			layui.data('tab_list_management',null);
		}
	};
	/**
	 * [del_other_data 删除其它]
