...
$("input[type=button]").click(function() {
	...
	console.log("进来了" + username + "," + password + "," + code);
	...
	if (username == "" || password == "" || code == "") {
		...
		return;
	} else if (!username.replace(/[^\w\/]/ig, '') || !password.replace(/[^\w\/]/ig, '') || !code.replace(/[^\w\/]/ig, '')) {
	...
	$.ajax({
		...
		data: "username=" + username + "&password=" + password + "&code=" + code, //发送请求的数据
