<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="pharmacy.common.model.UserInfo,pharmacy.web.management.model.dto.MenuDto,java.util.List" %>    
<!DOCTYPE html>
<html class="x-admin-sm">
		...
		<div class="layui-fluid">
			<div class="layui-row layui-col-space15">
				...
				<div class="layui-col-sm12 layui-col-md6">
					<div class="layui-card">
						<div class="layui-card-header">最近七天访问人数统计</div>
				...
				<div class="layui-col-sm12 layui-col-md6">
					<div class="layui-card">
						<div class="layui-card-header">药品采购统计</div>
						<div class="layui-card-body" style="min-height: 280px;">
	...
	<script src="../3rd/jq/echarts.min.js"></script>
		...
		$.ajax({
			...
			success : function(data) {
				...
				for(var i=0;i<data.length;i++){
                    var obj=new Object();
                    servicedata[i]=data[i].name;
                    servuale[i]=data[i].count
                }
	...
	function viewVolume(){
		$.ajax({
			...
			success : function(data) {
				...
				for(var i=0;i<data.length;i++){
                    var obj=new Object();
                    servalue[i]=data[i].tvCount;
					//分割
					ttDate = data[i].tvtime.replace(/(\d{4}).(\d{1,2}).(\d{1,2}).+/mg, '$1-$2-$3');
					serTime[i]=ttDate
                }
